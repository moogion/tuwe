...
class MainWindow {
 public:
  // Data
  string usertoa = "null";
  void dataReturn() { cout << usertoa << endl; }
      ...
      return vbox({
          ...
          hbox({
              ...
              vbox({
                  ...
                  filler(), filler(), humiditySlider->Render(),
      ...
      return vbox({
                 ...
                 hbox({
                     ...
                     color(Color::SkyBlue2,
                           text("Their Unbelievable Wisdom is Extraordinary")),
                     filler(),
                 }),

                 // hbox({
                 //   filler(),
                 //         color(Color::SkyBlue2 , text("Their Unbelievable
                 ...
                 hbox({
                     ...
                     color(Color::HSV(colorH, colorS, colorV),
